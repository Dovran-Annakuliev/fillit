...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/11 19:54:46 by rfork             #+#    #+#             */
/*   Updated: 2019/12/11 20:04:59 by rfork            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	**ft_old_change_arr(char *tmp, int count)
{
	...
	arr = ft_old_change_arr_2(tmp, count, heg, len);
	arr = ft_old_change_arr_3(arr, ret, arr2);
	free(arr2);
	arr2 = NULL;
	return (arr);
}
...
char	**ft_old_change_arr_3(char **arr, int ret, int *arr2)
{
	...
	ret = 0;
	arr = ft_old_change_arr_4(arr, ret, arr2);
	return (arr);
}
